...
from sklearn import linear_model, preprocessing, svm, metrics, tree
...
clf = DecisionTreeClassifier(criterion="gini", max_leaf_nodes=29, random_state=0)   #29=74.09
clf.fit(X_train_res, y_train_res)
...
cn=['LowRisk', 'MidRisk', 'HighRisk']
fig, axes = pyplot.subplots(nrows = 1,ncols = 1,figsize = (25,20), dpi=300)
